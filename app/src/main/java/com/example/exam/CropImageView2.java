...
public class CropImageView2 extends ImageView {
    ...
    private Fragment1.OnImageSizeChangedListener onImageSizeChangedListener;
    ...
    public void setListeners(@NotNull OnClickListener onClickListener, @NotNull Fragment1.OnImageSizeChangedListener onImageSizeChangedListener) {
